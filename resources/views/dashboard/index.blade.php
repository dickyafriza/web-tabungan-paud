            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-options d-flex align-items-center">
                        ...
                        <button id="btn-cetak-spp" class="btn btn-primary mr-2" style="white-space: nowrap;">Cetak</button>
                        <button id="btn-export-spp" class="btn btn-primary" style="white-space: nowrap;">Export</button>
                    </div>
