...
@section('page-name', (isset($periode) ? 'Ubah Tahun Ajaran' : 'Tahun Ajaran Baru'))
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row gutters-xs">
                                <div class="col-6">
                                    <input type="date" class="form-control" name="tgl_mulai" data-toggle="datepicker" placeholder="Tanggal Mulai" required autocomplete="off" value="{{ isset($periode) ? $periode->tgl_mulai : old('tgl_mulai') }}">
                                </div>
                                <div class="col-6">
                                    <input type="date" class="form-control" name="tgl_selesai" data-toggle="datepicker" placeholder="Tanggal Selesai" required autocomplete="off" value="{{ isset($periode) ? $periode->tgl_selesai : old('tgl_selesai') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
