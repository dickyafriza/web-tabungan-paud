...
Route::middleware(['auth:web'])->group(function () {
    ...
    Route::get('kelas/{id}/siswa', 'KelasController@getsiswa')->name('kelas.siswa');
    Route::get('kelas/{id}/export', 'KelasController@export')->name('kelas.export');
    Route::get('kelas/{id}/print', 'KelasController@print')->name('kelas.print');
